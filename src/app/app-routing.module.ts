...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/accounting/accounting.module')
                          .then((m) => m.AccountingPageModule),
                          canActivate: [AuthGuard],
                          data: { authGuardPipe: redirectUnauthorizedToHome}
  },
  {
    path: 'employee-register',
    loadChildren: () => import('./pages/employee-register/employee-register.module')
                          .then((m) => m.EmployeeRegisterPageModule),
                          canActivate: [AuthGuard],
                          data: { authGuardPipe: redirectUnauthorizedToHome}
  },
  {
  ...
  {
    path: 'sales-register',
    loadChildren: () => import('./pages/sales-register/sales-register.module')
                          .then((m) => m.SalesRegisterPageModule),
                          canActivate: [AuthGuard],
                          data: { authGuardPipe: redirectUnauthorizedToHome}
  },
  {
  ...
  {
    path: 'edit-invoice',
    loadChildren: () => import('./pages/edit-invoice/edit-invoice.module')
                          .then((m) => m.EditInvoicePageModule),
                          canActivate: [AuthGuard],
                          data: { authGuardPipe: redirectUnauthorizedToHome}
  },
  {
  ...
  {
    path: 'edit-user',
    loadChildren: () => import('./pages/edit-user/edit-user.module')
